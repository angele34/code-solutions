...
# AI was used for clarfying concepts for the lab assignment and to explain the built-in functions from python's socket module.
# ==============
# examples:
# difference between bind and connect
# why choose a server port number larger than 1023 and 5000
# how to accept an integer in socket programming (I couldn't find it in the documentation)
# what does decode and encode do
# ==============
# AI was not used to code the whole program.
